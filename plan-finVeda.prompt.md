...
3. Create minimal shared header/nav/footer content to use across pages; include links to Home, News, Education, Support, Login/Register, and app sections (View Financial Intelligence, Portfolio, Transactions, Behavioral, Projections, Risk, Tax, Goals, Alerts, Settings).
...
5. Establish primary flows: Login/Register → View Financial Intelligence → Portfolio → Transactions; Intelligence (Behavioral/Projections/Risk/Tax) and Plan (Goals/Alerts) reachable from sidebar; Resources (Support/Education/News) reachable from header/footer.
